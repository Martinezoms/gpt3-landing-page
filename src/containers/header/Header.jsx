...
const Header = () => {
  return (
    <div id="home" className="section__padding flex items-center tablet:flex-col">
      <div className="flex flex-col mr-20 justify-center items-start flex-1 tablet:m-auto">
        ...
        <div className="text-white font-medium text-xs leading-[38px] w-full flex gap-3 justify-start items-center mt-8 mid:flex-col">
